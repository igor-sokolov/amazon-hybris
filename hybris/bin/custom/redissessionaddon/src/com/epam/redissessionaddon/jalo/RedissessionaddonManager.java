 ...
 */
package com.epam.redissessionaddon.jalo;
...
import com.epam.redissessionaddon.constants.RedissessionaddonConstants;



/**
 * This is the extension manager of the Redissessionaddon extension.
 */
public class RedissessionaddonManager extends GeneratedRedissessionaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RedissessionaddonManager.class.getName());
	 ...
	 */
	public static RedissessionaddonManager getInstance()
	{
		return (RedissessionaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RedissessionaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RedissessionaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RedissessionaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RedissessionaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RedissessionaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
